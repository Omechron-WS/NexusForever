        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lootGroupId = table.Column<ulong>(type: "bigint(20) unsigned", nullable: false, defaultValue: 0ul),
                    comment = table.Column<string>(type: "varchar(200)", nullable: false, defaultValue: "")
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__entity_loot_lootGroupId__loot_group_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => new { x.id, x.lootGroupId });
                    table.ForeignKey(
                        name: "FK__item_loot_lootGroupId__loot_group_id",
                        column: x => x.lootGroupId,
                        principalTable: "loot_group",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
