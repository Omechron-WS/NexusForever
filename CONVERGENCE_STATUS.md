...
| 6 — Entity vitals and lifecycle | In progress | Wire-compatible vital aliases, focus property data, persistence-safe initial pools, deterministic unit/class regeneration, idempotent death and rewards, corpse cleanup, persistent non-player respawn, transactional build-16042 base and activation-batch per-effect vital costs, and a bounded central effect timeline are live and tested. VitalModifier formulas, threshold-child casting, sprint, dash, and the remaining class-resource action hooks are incomplete. |
...
- Finish the remaining Phase 2 spell variants, unit-capable effect prerequisites, VitalModifier semantics, and persistent-effect lifecycle before relying on threshold or formula-driven effects for broader scripted combat content.
...
1. Close the remaining Phase 4 unit-capable effect-prerequisite gap and Phase 6 VitalModifier work, then complete threshold casting, dash, and sprint.
